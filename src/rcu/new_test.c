...
static void *updater_func(void *argv)
{
    ...
    while (i++ < N_UPDATE_RUN) {
        ...
        newval->count = i;
        oldp = mthpc_rcu_replace_pointer(dut, newval);
...
int main(int argc, char *argv[])
{
    ...
    dut = (struct test *)malloc(sizeof(struct test));
    dut->count = 0;
